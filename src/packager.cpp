...
int main( int argc, char** argv) {
	...
	std::vector<std::string> shadersToLoad = { "flashes", "notes", "particles", "particlesblur", "screenquad", "majorKeys", "minorKeys", "backgroundtexture", "pedal", "wave", "fxaa", "wave_noise", "score_bars", "score_labels", "shadowblur", "shadow"};

...
void State::defineOptions(){
	...
	_sharedInfos[s_score_digits_font_path_key] 	= {Category::SCORE, s_score_digits_font_path_dsc, Type::PATH};
...
void State::updateOptions(){
	...
	_pathInfos[s_score_digits_font_path_key] = &score.digitsFontPath;
